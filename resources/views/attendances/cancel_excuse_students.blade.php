    ...
    <div class="col">
        <div class="p-4">
            ...
            <form action="{{ route('excuse.cancel.apply') }}" method="POST">
                    ...
                    <tbody>
                        @foreach($attendances as $attendance)
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input type="hidden" name="attendance[{{ $attendance->attendance_id }}][status_morning]" value="">
                                        <input type="checkbox" name="attendance[{{ $attendance->attendance_id }}][status_morning]" value="excused" 
                                ...
                                <td>
                                    <label>
                                        <input type="hidden" name="attendance[{{ $attendance->attendance_id }}][status_lunch]" value="">
                                        <input type="checkbox" name="attendance[{{ $attendance->attendance_id }}][status_lunch]" value="excused" 
                ...
                <!-- Submit Button for Applying Excuses -->
